...
//int CastorEncryptACKAuth::encrypt(uint8_t * toEnc,int toEncLength,uint8_t * enc, IPAddress destination){
//int CastorEncryptACKAuth::encrypt(uint8_t * toEnc,int toEncLength,uint8_t * enc, IPAddress destination){
//
//
...
////void CastorEncryptACKAuth::testcrypt(uint8_t * toEnc,int toEncLength, IPAddress destination){
//void CastorEncryptACKAuth::testcrypt(Botan::SecureVector<Botan::byte> plain, IPAddress destination){
//
